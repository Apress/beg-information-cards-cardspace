...
namespace BeginningCardSpace
{
    public class ManagedCardHelper
    {
        ...
        public static X509Certificate2 RetrieveCertificate(string certificateLocation)
        {
            ...
            //TODO: Determine why certificateLocation is not saving properly
            certificateLocation = "LOCALMACHINE/MY/www.fabrikam.com";
            //load from store
        ...
        public void SaveInformationCard(XmlElement signedInformationCard, string filename)
        {
            ...
            signedInformationCard.WriteTo(fileWriter);
